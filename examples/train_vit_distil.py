...
from vit_pytorch.distill import DistillableViT, DistillWrapper, DistillableMobileViT
...
stu_model = DistillableMobileViT(
    image_size = (224, 224),
    dims=[64, 80, 96],
